...
import { CheckCircle, BadgeCheck, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="px-8 py-12">
        ...
        >
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-zinc-900" style={{ ...serif, fontSize: '28px' }}>
                      95<span className="text-zinc-400">/100</span>
                    </p>
                  </div>
                  <div>
                    <p className="text-zinc-500 mb-1" style={{ fontSize: '12px' }}>
                ...
                <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-3 text-center">
                  <p className="text-zinc-500 mb-1" style={{ fontSize: '11px' }}>
                    {t('certificate_id')}
                  </p>
                  <p className="text-zinc-900 font-mono" style={{ fontSize: '13px' }}>
                    0x7f3a...9e2b
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            {[
              { value: 1, labelKey: 'certificates', accent: 'text-zinc-900' },
              { value: 3, labelKey: 'jobs_unlocked', accent: 'text-zinc-900' },
              { value: 95, labelKey: 'skill_score', accent: 'text-emerald-600' },
            ].map((s) => (
              <div
                key={s.labelKey}
